        ...
        ;WITH Src AS
                  (
                      SELECT
                          ...
                          sku_style_color_clean =
                              NULLIF(
                                      REPLACE(
                                              REPLACE(
                                                      REPLACE(
                                                              REPLACE(LTRIM(RTRIM(r.sku_style_color)), NCHAR(160), N''),
                                                              NCHAR(8239),
                                                              N''
                                                          ),
                                                      N' ',
                          ...
                          stock_stores_dd_clean = NULLIF(REPLACE(REPLACE(REPLACE(REPLACE(LTRIM(RTRIM(r.stock_stores_dd)), NCHAR(160), N''), NCHAR(8239), N''), N' ', N''), N',', N'.'), N'')
              ...
              Typed AS
                  (
                      SELECT
                          ...
                          sku_style_color_bigint =
                              TRY_CONVERT(BIGINT, TRY_CONVERT(FLOAT, s.sku_style_color_clean)),
        ...
        ;WITH Src AS
                  (
                      SELECT
                          ...
                          sku_style_color_clean =
                              NULLIF(REPLACE(REPLACE(REPLACE(REPLACE(LTRIM(RTRIM(r.sku_style_color)), NCHAR(160), N''), NCHAR(8239), N''), N' ', N''), N',', N'.'), N''),
         ...
         SELECT
             t.LoadSessionId,
             t.nazvanie_clean,
             CONVERT(INT, t.god_float),
             CONVERT(INT, t.sezon_float),
             CONVERT(INT, t.den_float),
             t.data_value,
             ...
             t.sku_style_color_bigint,
             t.sku_phase_clean,
             CONVERT(DECIMAL(18,2), ROUND(t.stock_start_pcs_float, 2)),
             CONVERT(DECIMAL(18,2), ROUND(t.stock_start_dd_float, 2)),
             CONVERT(DECIMAL(18,2), ROUND(t.sales_pcs_float, 2)),
             CONVERT(DECIMAL(18,2), ROUND(t.sales_rub_float, 2)),
             CONVERT(DECIMAL(18,2), ROUND(t.revenue_float, 2)),
             CONVERT(DECIMAL(18,2), ROUND(t.gp_float, 2)),
             CONVERT(DECIMAL(18,2), ROUND(t.cogs_float, 2)),
             CONVERT(DECIMAL(18,2), ROUND(t.sales_frp_price_float, 2)),
             CONVERT(DECIMAL(18,2), ROUND(t.sales_discount_float, 2)),
             CONVERT(DECIMAL(18,2), ROUND(t.stock_stores_pcs_float, 2)),
             CONVERT(DECIMAL(18,2), ROUND(t.stock_stores_dd_float, 2)),
             CONVERT(INT, t.plan_rub_float),
             t.draivery_cd_clean,
